function [] = FeatureSelectionOvarianCDPostQAQC ()
...
[h_ttest,p_ttest,ci_ttest] = ttest2(DatosEntrenamientoG1 , ...
    DatosEntrenamientoG2 ,'Vartype','unequal');
%
...
xlabel('P value');
ylabel('CDF value');
title('Funcion de Probabilidad T-test OvarianCDPostQAQC')
...
xlabel('P value');
ylabel('CDF value');
title('Funcion de Probabilidad Wilcoxon OvarianCDPostQAQC')
...
xlabel('P value');
ylabel('CDF value');
title('Funcion de Probabilidad Chi2 OvarianCDPostQAQC')
